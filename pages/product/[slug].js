...
const ProductDetails = ({ product, products }) => {
  ...
  const notify = () => {
    toast.success("Aggiunto. Controlla il tuo carrello!", {
          ...
          <div className="flex-[1] py-3">
            ...
            <div className="mb-10">
              <div className="flex justify-between mb-2">
                <div className="text-md font-semibold">Seleziona taglia</div>
              </div>
            ...
            <div>
              <div className="text-lg font-bold mb-5">Dettagli prodotto</div>
